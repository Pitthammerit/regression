    ...
    <SectionWrapper id="cases" data-testid="cases-section">
      <div className="max-w-2xl mb-6">
        ...
        <DebugLabel type="h2" debugMode={debugMode}>
          <h2 className="font-display text-h2 text-heading leading-tight">
            {cases.headline}
          </h2>
        </DebugLabel>
            ...
            >
              ...
              <div className="flex-1 pr-4">
                ...
                <DebugLabel type="h4" debugMode={debugMode}>
                  <span className="font-display text-h4 text-heading group-hover:text-label transition-colors block leading-snug">
