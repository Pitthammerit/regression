      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div className="md:sticky md:top-28">
          <div className="aspect-[16/9] md:aspect-[3/4] rounded-2xl overflow-hidden bg-brand-sand w-full md:max-w-sm">
            <LazyImage
              ...
              fallback={
                <div className="w-full h-full flex items-center justify-center text-body font-primary text-body">
        ...
        <div>
          ...
          <DebugLabel type="h3" debugMode={debugMode}>
            <h2 className="font-display text-h3 text-semantic-heading mb-10 leading-tight">
              {about.headline}
            </h2>
          </DebugLabel>
              ...
              {about.credentials.map((cred, i) => (
                <li key={i} className="font-primary text-list text-body flex items-start gap-2">
                  <DebugLabel type="list" debugMode={debugMode}>
                    <span className="text-semantic-heading shrink-0 mt-0.5">—</span>
                    {cred}
                  </DebugLabel>
                </li>
              ))}
