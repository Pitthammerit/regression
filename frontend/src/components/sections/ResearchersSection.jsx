  ...
  return (
    ...
    >
      ...
      <div className="max-w-content mx-auto px-6 md:px-10 lg:px-16 relative z-10">
        ...
        {/* Featured Researcher */}
        {featuredAuthor && (
          <div className="flex flex-col md:grid md:grid-cols-[260px_1fr] md:gap-12 section-block-spacing">
            ...
            <div className="hidden md:block md:max-w-[260px]">
        ...
        {authors.map((author, index) => (
          <div key={author.id} className={index === authors.length - 1 ? 'mb-10' : 'mb-12'} data-testid={`researcher-${author.id}`}>
            ...
            <div className="flex flex-col md:grid md:grid-cols-[260px_1fr] md:gap-12 md:items-start">
              ...
              {author.portrait && (
                <div className="hidden md:block md:max-w-[260px] transition-all duration-[500ms] ease-in-out">
