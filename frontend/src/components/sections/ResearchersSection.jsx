  ...
  return (
    ...
    >
      ...
      <div className="max-w-content mx-auto px-6 md:px-10 lg:px-16 relative z-10">
        ...
        {/* Featured Researcher */}
        {featuredAuthor && (
          <div className="flex flex-col md:grid md:grid-cols-[255px_1fr] md:card-grid-gap-lg margin-top-sm section-block-spacing">
        ...
        {authors.map((author, index) => (
          <div key={author.id} className={index === authors.length - 1 ? 'mb-10' : 'mb-16'} data-testid={`researcher-${author.id}`}>
            ...
            <div className="flex flex-col md:grid md:grid-cols-[255px_1fr] md:card-grid-gap-lg md:items-start">
