  ...
  return (
    <SectionWrapper id="cases" data-testid="cases-section">
      ...
      <div className="flex justify-center pb-4">
        ...
        >
          <ChevronDown className="next-arrow-button animate-pulse-down" />
        </button>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        C15.709,7.743,18.744,5.07,18.835,4.991z"/>
              ...
              <div className="flex-1 pr-4">
                ...
                <DebugLabel type="typography-body-italic" debugMode={debugMode}>
                  <span className="typography-body-italic block element-spacing-xs">
                    {item.teaser}
                  </span>
                </DebugLabel>
              </div>
