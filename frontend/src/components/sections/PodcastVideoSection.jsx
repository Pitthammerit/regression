    ...
    <>
      ...
      >
        <div className="flex items-start justify-between px-8 pt-8 pb-6 border-b border-black/8">
          <div>
            <p className="font-sans text-xs uppercase tracking-[0.18em] text-brand-steel mb-1">{podcastVideo.panelLabel}</p>
        ...
        <div className="flex-1 overflow-y-auto px-8 py-6">
          ...
          {fluentTranscriptUrl ? (
            ...
            <div className="space-y-4" data-testid="transcript-placeholder-form">
              <div>
                <label className="font-sans text-xs uppercase tracking-widest text-brand-steel block mb-2">{podcastVideo.nameLabel}</label>
                <input type="text" placeholder={podcastVideo.namePlaceholder} className="w-full bg-white/60 border border-black/12 rounded-lg px-4 py-3 font-sans text-sm text-brand-body placeholder:text-brand-muted/50 focus:outline-none focus:border-brand-deep/40 transition-colors" data-testid="transcript-name-input" />
              </div>
              <div>
                <label className="font-sans text-xs uppercase tracking-widest text-brand-steel block mb-2">{podcastVideo.emailLabel}</label>
                <input type="email" placeholder={podcastVideo.emailPlaceholder} className="w-full bg-white/60 border border-black/12 rounded-lg px-4 py-3 font-sans text-sm text-brand-body placeholder:text-brand-muted/50 focus:outline-none focus:border-brand-deep/40 transition-colors" data-testid="transcript-email-input" />
              </div>
