        ...
        {featuredAuthor && (
          <div className="flex flex-col md:grid md:grid-cols-[240px_1fr] md:gap-8 mb-16">
            ...
            <div className="flex flex-col">
              ...
              <blockquote className="font-secondary text-quote-featured italic leading-tight text-on-dark-muted mb-6">
                "{featuredAuthor.featuredQuote}"
              </blockquote>

              {/* Name + Title - Below quote */}
              <div className="text-on-dark-muted">
                <div className="font-secondary text-author-name">{featuredAuthor.name}</div>
            ...
            <div className="flex flex-col md:grid md:grid-cols-[240px_1fr] md:gap-8 md:items-start">
              ...
              <div className="flex flex-col">
                ...
                <div className="md:hidden mb-4">
                  <h3 className="font-secondary text-author-name text-on-dark mb-1">
                    {author.name}
                  </h3>
                ...
                {/* Short text */}
                <p className="font-secondary text-description text-on-dark-muted leading-relaxed mb-6">
                  {author.shortVersion}
                </p>
            ...
            {expandedId === author.id && (
              <>
                <div className="mt-4 pt-8 md:col-span-2">
                  <p className="font-secondary text-body-narrative text-on-dark-muted leading-relaxed mb-6 whitespace-pre-line">
                    {author.longVersion}
                  </p>
                  {author.sourceUrl && (
                    <a
