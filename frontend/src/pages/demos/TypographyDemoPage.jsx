...
export default function TypographyDemoPage() {
  ...
  return (
    <div className="bg-background-light bg-paper min-h-screen font-sans text-color-tertiary">
      {/* Debug Toggle - Fixed */}
      ...
      <div className="max-w-content mx-auto px-6 py-20">
        ...
        <div className="mb-16 pb-8 border-b border-black/10">
          <p className="font-sans text-xs tracking-[0.2em] uppercase text-color-secondary mb-4">
            DESIGN EXPLORATION
          </p>
          <h1 className="font-serif text-4xl md:text-5xl text-color-primary leading-tight mb-4">
            Typography Demo
          </h1>
          <p className="font-sans text-color-tertiary text-lg max-w-2xl">
        ...
        <div className="mb-8 border border-black/10 rounded-lg overflow-hidden bg-white">
          <button
            ...
            className="w-full px-6 py-4 flex items-center justify-between bg-background-dark text-white hover:bg-brand-steel transition-colors"
          >
          ...
          {accordionOpen === 'tokens' && (
            <div className="p-6">
              <p className="font-sans text-sm text-color-tertiary mb-6">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Hero Haupt-Headline</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Hero Sub-Headline</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Section H3</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Section H2</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-50 rounded">h1</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">—</td>
                      <td className="py-3 px-4 font-mono text-xs">3rem (48px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Section H1</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Section H4</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Body Text Basis</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Body Text Large</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Labels, Metadata</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">LetterSpreading Labels</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">LetterSpreading Headlines</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">0.75rem (12px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Disclaimer-Texte</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Mehr lesen / Weniger lesen Buttons</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">0.875rem (14px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Button-Texte (allgemein)</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">0.875rem (14px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Quellen-Links</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Sublines (unter H2, unter Namen)</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">1rem (16px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">List-Items (Credentials, Bullets)</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Autoren-Namen</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Kurzbeschreibungen</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">1.5rem (24px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Standard Zitate</td>
                    </tr>
                    <tr className="border-b border-black/10">
                      ...
                      <td className="py-3 px-4 font-mono text-xs">2.25rem (36px)</td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Große Zitate</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    ...
                    {/* ═══════════════════════════════════════════════════════════ */}
                    <tr>
                      <td colSpan="4" className="py-2 px-4 text-xs font-semibold text-color-primary bg-background-light/50 uppercase tracking-[0.15em]">
                        Gruppe 1: Basiselemente
                      </td>
                    </tr>
                    ...
                    {/* LABEL */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Label</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-label text-color-secondary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-label text-color-secondary">EVIDENZBASIERT</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">WhatIs, About, CaseStudies, Researchers</td>
                    </tr>

                    {/* H2 */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">H2</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-h3</td>
                      <td className="py-3 px-4">
                        <span className="font-serif text-h3 text-color-primary leading-tight">Was die Forschung sagt</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">WhatIs, About, CaseStudies, Researchers</td>
                    </tr>
                    ...
                    {/* H3 */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">H3</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-h4</td>
                      <td className="py-3 px-4">
                        <span className="font-serif text-h4 text-color-primary">Marina S.</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies (Item Name), Researchers (Author Name)</td>
                    </tr>

                    {/* BODY */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Body</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-body</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-body text-color-tertiary leading-relaxed">Fließtext mit Standardgröße für lesbaren Inhalt.</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">WhatIs, About</td>
                    </tr>

                    {/* SUBLINE */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Subline</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-subline text-color-tertiary italic</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-subline text-color-tertiary italic">Ergänzender Text in Kursiv (16px)</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies (unter H2, unter Namen)</td>
                    </tr>

                    {/* QUOTE */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Quote</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-quote-featured italic</td>
                      <td className="py-3 px-4 bg-background-dark">
                        <span className="font-serif text-quote-featured italic leading-tight text-on-dark-heading">"The evidence suggests..."</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Researchers (Featured)</td>
                    </tr>
                    ...
                    {/* DISCLAIMER */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Disclaimer</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-disclaimer text-color-tertiary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-disclaimer text-color-tertiary">* Namen wurde geändert</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies</td>
                    </tr>

                    {/* TEASER */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Item Teaser</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-base text-color-tertiary italic</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-base text-color-tertiary italic">Kurzbeschreibung des Falls</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies</td>
                    </tr>
                    ...
                    {/* LEAD */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Lead (Short)</td>
                      ...
                      <td className="py-3 px-4 text-xs text-color-tertiary">Researchers</td>
                    </tr>

                    {/* LIST */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">List</td>
                      <td className="py-3 px-4 font-mono text-xs bg-green-100 rounded text-green-800">text-list text-color-tertiary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-list text-color-tertiary">— NLP Master (16px)</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">About (Credentials Items)</td>
                    </tr>
                    ...
                    {/* READ MORE */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Read More</td>
                    ...
                    {/* LINK */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Link</td>
                    ...
                    {/* ROLE */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Role</td>
                    ...
                    {/* DATE */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Date</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-sm text-on-dark-date</td>
                      <td className="py-3 px-4 bg-background-dark">
                        <span className="font-sans text-sm text-on-dark-date">*1918–2007</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">Researchers</td>
                    </tr>
                    ...
                    {/* NAME */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Name</td>
                    ...
                    {/* TAG */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Item Tag</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-sm tracking-[0.15em] uppercase text-color-secondary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-sm tracking-[0.15em] uppercase text-color-secondary">HEILUNG</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies</td>
                    </tr>
                    ...
                    {/* CREDENTIALS LABEL */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Credentials Label</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-label text-color-secondary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-label text-color-secondary">AUSBILDUNGEN & ZERTIFIZIERUNGEN</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">About</td>
                    </tr>

                    {/* CREDENTIALS ITEM */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Credentials Item</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-sm text-color-tertiary</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-sm text-color-tertiary">— NLP Master & NR Practitioner</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">About</td>
                    </tr>
                    ...
                    {/* SECTION BODY */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Section Body</td>
                      <td className="py-3 px-4 font-mono text-xs bg-yellow-100 rounded">text-base md:text-lg text-color-tertiary leading-relaxed</td>
                      <td className="py-3 px-4">
                        <span className="font-sans text-base md:text-lg text-color-tertiary leading-relaxed">Detaillierter Beschreibungstext</span>
                      </td>
                      <td className="py-3 px-4 text-xs text-color-tertiary">CaseStudies (Situation/Session/Result)</td>
                    </tr>

                    {/* SHORT VERSION */}
                    <tr className="border-b border-black/10">
                      <td className="py-3 px-4 font-semibold text-color-primary">Short Version</td>
                    ...
                    {/* LONG VERSION */}
                    <tr>
                      <td className="py-3 px-4 font-semibold text-color-primary">Long Version</td>
        ...
        <div className="mb-16 pb-8 border-t border-black/10">
          <h2 className="font-serif text-2xl text-color-primary mb-4">📝 Live Sections</h2>
          <p className="font-sans text-sm text-color-tertiary">
        ...
        <div className="mt-20 pt-8 border-t border-black/10 text-center">
          <p className="font-sans text-sm text-color-secondary">
